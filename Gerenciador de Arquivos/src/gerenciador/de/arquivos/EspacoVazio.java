...
public class EspacoVazio {
    ...
    public static void gravaEspacoVazio() throws IOException {
        ...
        while (true) {
            ...
            for (int i = 0; i < listaRegistro.size(); i++) {
                ...
                if ((maior == null) || (maior.getTamanho() < atual.getTamanho())) {
                    maior = atual;
                }
            }
            
            String Tamanho = Indice.preencherNaFrente(String.valueOf(maior.getTamanho()), 10, ' ');
